...
import { toggleDarkMode, backToMain } from './ui.js?v=1756588063';
import { showSettings, editSettings, saveSettings } from './settings.js?v=1756580818';
import { toggleExpand, handleNodeClick, handleFolderIconClick, exitFocusMode, toggleTaskComplete, createNode, deleteCurrentNode, editFocusedNodeTitle, handleFocusTitleClick } from './nodes.js?v=1756588063';
import { toggleAddForm, quickCreateFolder, quickCreateNote, quickCreateTask, quickCreateSmartFolder, quickCreateTemplate, useCurrentTemplate, instantiateTemplate, loadParentOptions, setAddType } from './creation.js?v=1756588063';
...
window.deleteNoteFromView = deleteNoteFromView;
